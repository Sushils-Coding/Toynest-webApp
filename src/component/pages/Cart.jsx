...
const Cart = () => {
    ...
    const toggleWishlist = (id) => {
        ...
        const isInWishlist = wishlistItems.some(itemId => String(itemId) === stringId);
    ...
    const getToyById = (id) => {
        return toys.find(toy => 
            toy.id.toString() === id.toString() // Compare as strings
        );
    };
                                        ...
                                        return (
                                            <div key={item.id} className="rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 md:p-6">
                                                <div className="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                                                    <Link to={`/toy/${item.id}`} className="shrink-0 md:order-1">
                                                        <img
                                                            src={toy.image}
                                                            alt={toy.name}
                                                    ...
                                                    <div className="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
                                                        <Link to={`/toy/${item.id}`} className="text-base font-medium text-gray-900 hover:underline dark:text-white">
                                                            {toy.name}
                                                        </Link>
                                                        ...
                                                        <div className="flex items-center gap-4">
                                                            ...
                                                            >
                                                                <svg
                                                                    className={`me-1.5 h-5 w-5 ${isWishlisted ? 'text-red-500 fill-current' : 'text-purple-600'}`}
                                                                    aria-hidden="true"
                                    ...
                                    <div className="space-y-4">
                                        <div className="space-y-2">
                                            ...
                                            <dl className="flex items-center justify-between gap-4">
                                                ...
                                                <dd className="text-base font-medium text-gray-900 dark:text-white">Calculated at checkout</dd>
                                            </dl>
                                        </div>
